...
public abstract class OnlineScreen extends BorderPane {
    ...
    public OnlineScreen() {
        ...
        imageView.setImage(new Image(getClass().getResource("../../Downloads/icons8-person-50%20(1).png").toExternalForm()));
        ...
        imageView0.setImage(new Image(getClass().getResource("../../Downloads/search.png").toExternalForm()));
        ...
        imageView1.setImage(new Image(getClass().getResource("../../Downloads/icons8-boxing-glove-48.png").toExternalForm()));
        ...
        imageView2.setImage(new Image(getClass().getResource("../../Downloads/icons8-status-100.png").toExternalForm()));

        imageView3.setFitHeight(109.0);
        imageView3.setFitWidth(105.0);
        imageView3.setPickOnBounds(true);
        imageView3.setPreserveRatio(true);
        imageView3.setImage(new Image(getClass().getResource("../../Downloads/icons8-person-64.png").toExternalForm()));
        ...
        imageView4.setImage(new Image(getClass().getResource("../../Downloads/icons8-status-100.png").toExternalForm()));

        imageView5.setFitHeight(109.0);
        imageView5.setFitWidth(105.0);
        imageView5.setPickOnBounds(true);
        imageView5.setPreserveRatio(true);
        imageView5.setImage(new Image(getClass().getResource("../../Downloads/icons8-person-64.png").toExternalForm()));
        ...
        imageView6.setImage(new Image(getClass().getResource("../../Downloads/icons8-status-100.png").toExternalForm()));

        imageView7.setFitHeight(109.0);
        imageView7.setFitWidth(105.0);
        imageView7.setPickOnBounds(true);
        imageView7.setPreserveRatio(true);
        imageView7.setImage(new Image(getClass().getResource("../../Downloads/icons8-person-64.png").toExternalForm()));
        ...
        imageView8.setImage(new Image(getClass().getResource("../../Downloads/icons8-status-100.png").toExternalForm()));

        imageView9.setFitHeight(109.0);
        imageView9.setFitWidth(105.0);
        imageView9.setPickOnBounds(true);
        imageView9.setPreserveRatio(true);
        imageView9.setImage(new Image(getClass().getResource("../../Downloads/icons8-person-64.png").toExternalForm()));
        ...
        imageView10.setImage(new Image(getClass().getResource("../../Downloads/icons8-status-100.png").toExternalForm()));
        ...
        imageView11.setImage(new Image(getClass().getResource("../../Downloads/icons8-person-64.png").toExternalForm()));
