...
public class Constants {
    ...
    public final static String SERVER_RUNNING = "SERVER_RUNNING";
    
public final static String GET_USERS = "GET_USERS";
    
public    final static String LOGIN="LOGIN";
    public final static String VALID_LOGIN = "VALID_LOGIN";
    public    final static String NOT_VALID_LOGIN="NOT_VALID_LOGIN";

    public    final static String WAIT="W";

    public final static String SEND_REQUEST_TO_PLAY = "SEND_REQUEST_TO_PLAY";
    public final static String RECEIVE_RESPONSE_FROM_USER = "SEND_REQUEST_TO_PLAY";
    ...
    public final static String PLAY_WITH_USER_RESPONSE = "PLAY_WITH_USER_RESPONSE";
      ...
      public final static String THAT_ISNOT_ME = "ThatIsNotMe";
            public final static String THAT_IS_ME = "ThatIsMe";

                  public final static String THAT_ISNOT_MER = "ThatIsNotMeR";
            public final static String THAT_IS_MER = "ThatIsMeR";
